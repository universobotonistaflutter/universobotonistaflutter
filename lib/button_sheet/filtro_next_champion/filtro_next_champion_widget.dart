...
import 'filtro_next_champion_model.dart';
export 'filtro_next_champion_model.dart';

class FiltroNextChampionWidget extends StatefulWidget {
  const FiltroNextChampionWidget({
    super.key,
  ...
  @override
  State<FiltroNextChampionWidget> createState() =>
      _FiltroNextChampionWidgetState();
}

class _FiltroNextChampionWidgetState extends State<FiltroNextChampionWidget> {
  late FiltroNextChampionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FiltroNextChampionModel());
                ...
                child: Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'poa8u1xj' /* Posição a ser escolhida */,
                    ),
          ...
          children: [
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('FILTRO_NEXT_CHAMPION_ADICIONE_BTN_ON_TAP');
