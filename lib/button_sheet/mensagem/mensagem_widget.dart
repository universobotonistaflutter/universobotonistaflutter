                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MENSAGEM_COMP_Icon_wi3en6av_ON_TAP');
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ewx73vnt' /* Melhorias e Sugestôes */,
                              ),
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent('MENSAGEM_COMP_ENVIAR_BTN_ON_TAP');
                            logFirebaseEvent('Button_backend_call');

                            await currentUserReference!
                                .update(createUserRecordData(
                              phoneNumber: _model.telefoneController.text,
                            ));
                            if (currentPhoneNumber != '') {
                              logFirebaseEvent('Button_launch_u_r_l');
                              await launchURL(
                                  'https://api.whatsapp.com/send?phone=+5541991430659&text=${_model.textController2.text}');
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: const Text(
                                        'Você precisa informar seu Número para enviar a mensagem.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
