      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            '4ayn6bzv' /* Deseja excluir sua conta... */,
          ))),
        );
      }
    }
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(FFLocalizations.of(context).getText(
            'docaoky7' /* Favor fazer o Login novamente ... */,
          ))),
        );
      }
    }
  ...
  Future resetPassword({
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(FFLocalizations.of(context).getText(
          '3cn8fvmo' /* Error; Erro de Autenticação... */,
        ))),
      );
      return null;
    }
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        '3cxpg6he' /* Enviado e-mail para redefiniçã... */,
      ))),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : UniversoBotonistaFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
      final errorMsg = switch (e.code) {
        'email-already-in-use' => FFLocalizations.of(context).getText(
            '1ylshvv4' /* Email já está em uso... */,
          ),
