...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1C4494);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF1C4494);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF1C4494);
  ...
  late Color lineColor = const Color(0xFF1C4494);
  late Color primaryBtnText = const Color(0xFFFFFFFF);
  late Color grayIcon = const Color(0xFFFFFFFF);
  late Color gray200 = const Color(0x24558BF8);
  late Color gray600 = const Color(0xFF1C4494);
  late Color black600 = const Color(0x24558BF8);
