...
import 'consulta_jogos_widget.dart' show ConsultaJogosWidget;
import 'package:flutter/material.dart';

class ConsultaJogosModel extends FlutterFlowModel<ConsultaJogosWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in ConsultaJogos widget.
